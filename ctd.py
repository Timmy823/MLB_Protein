...
trainX = np.load('ctdtrain_X.npy') 
trainY = np.load('ctdtrain_Y.npy')
validX = np.load('ctdvalidation_X.npy') 
validY = np.load('ctdvalidation_Y.npy')
with open('ctd_result.txt', 'a') as f:          #write file
